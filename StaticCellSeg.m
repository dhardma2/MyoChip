...
filename1=sprintf('pos%d-D%d-ActinBW.tif',pos,D);
MTBW=imread(filename1);
MTBW=MTBW(1:L2,1:L2);
%figure;imshow(MTBW)
filename2=sprintf('pos%d-D%d-DNABW.tif',pos,D);
filename3=sprintf('pos%d-D%d-Actin.tif',pos,D);
Actin=imread(filename3)*EF;
Actin=Actin(1:L2,1:L2);
filename4=sprintf('pos%d-D%d-DNA.tif',pos,D);
Nuclei=imread(filename4)*EF;
Nuclei=Nuclei(1:L2,1:L2);
MCBW=imread(filename2);
MCBW=MCBW(1:L2,1:L2);
MCBW=imbinarize(MCBW);
